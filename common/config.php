<?php
$sInitialBN="বর্তমান বাংলা";
$sInitialEN="Bartoman Bangla";
$sSiteName="বর্তমান বাংলা | Bartoman Bangla";
$sSiteTitle="বর্তমান বাংলা | Bartoman Bangla";
$sAuthor="www.BartomanBangla.com";
$sDeveloper="emythmakers.com";
$sEmail="editor@BartomanBangla.com";
$sAppId="";

//Local
$sSiteURL="http://localhost/BartomanBangla/";
$sCurrURL="http://localhost/BartomanBangla".$_SERVER["REQUEST_URI"];
